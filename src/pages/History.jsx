  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-6">
          <h1 className="text-2xl font-bold mb-6">Trade History & Learning Snippets</h1>

          {/* Mini Chart Placeholder */}
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            <h2 className="text-sm font-semibold mb-2 text-gray-600">Portfolio Performance (last 14 days)</h2>
          ...
          <Card>
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                Start your first trade in the Portfolio
              </p>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-gray-600">
                        {entry.qty} @ {entry.price.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}
                      </span>
                    </div>
